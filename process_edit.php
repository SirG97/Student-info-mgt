...
try{
    ...
    $sql ="UPDATE students set title=:title, surname=:surname, othername=:othername, dob=:dob, country=:country, courses=:courses, u_address=:u_address, post_code=:post_code, a_address=:a_address, a_post_code=:a_post_code, qualification=:qualification, experience=:experience, qualification=:qualification, sponsor=:sponsor, sponsor_detail=:sponsor_d, toefl_score=:toefl_score, toefl_date=:toefl_date WHERE student_id=:student_id";
